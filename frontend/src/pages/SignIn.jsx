  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
          <form className='w-[70%] h-[500px] max-w-[400px] bg-black/40 backdrop-blur shadow-lg shadow-black rounded-2xl
           flex flex-col items-center justify-center gap-10 px-[15px]' onSubmit={handleSignIn}>
            <h1 className='text-white text-[25px] font-semibold mb-[10px]'>Sign In to <span className='text-blue-400'>Virtual Assistant</span></h1>
